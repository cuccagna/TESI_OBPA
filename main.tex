...
\usepackage{csquotes}
\usepackage[backend=bibtex,style=numeric-comp, doi=true,url=true]{biblatex}
...
\vspace{10mm}
{\large{Tesina per il Corso di\textbf{  INTELLIGENZA ARTIFICIALE}}}\\
\vspace{2mm}
{\large{Docente:\textbf{ Chiar.mo Prof. Salvatore Gaglio}}}
\end{center}
\vspace{12mm}
\begin{center}
...
\vspace{20mm}
\begin{center}
{\large Anno Accademico\\2015\textbackslash16 }%inserire l'anno accademico a cui si è iscritti
\end{center}
\end{titlepage}
